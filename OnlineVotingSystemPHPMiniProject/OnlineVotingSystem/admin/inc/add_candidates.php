...
?>
        <div class="alert alert-danger my-3" role="alert">
            Candidate image is too large, please upload a smaller file (up to 2MB allowed).
        </div>
<?php
                ...
                <select class="form-control" name="election_id" required> 
                    ...
                    <?php 
                        ...
                        if($isAnyElectionAdded > 0)
                        {
                            ...
                            {
                                $election_id = isset($row['id']) ? $row['id'] : '';
                                $election_name = isset($row['election_topic']) ? $row['election_topic'] : '';
                                $allowed_candidates = isset($row['no_of_candidates']) ? $row['no_of_candidates'] : '';
            ...
            <tbody>
                <?php 
                    ...
                    if($isAnyCandidateAdded > 0)
                    {
                        ...
                        {
                            $election_id = isset($row['election_id']) ? $row['election_id'] : '';
                            ...
                            $election_name = isset($execFetchingElectionNameQuery['election_topic']) ? $execFetchingElectionNameQuery['election_topic'] : '';
